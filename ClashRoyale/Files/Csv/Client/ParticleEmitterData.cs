namespace ClashRoyale.Files.Csv.Client
{
    public class ParticleEmitterData : CsvData
    {
        ...
        public int ShadowMulR
        {
            get; set;
        }

        public int ShadowMulG
        {
            get; set;
        }

        public int ShadowMulB
        {
            get; set;
        }

        public int ShadowMulA
        {
            get; set;
        }

        public bool InverseSpeed
        {
            get; set;
        }
        ...
        public string TrailSwf
        {
            get; set;
        }

        public string TrailExportName
        {
            get; set;
        }
        ...
        public bool FrameFromAngle
        {
            get; set;
        }

        public int RotateMinSpeed
        {
            get; set;
        }

        public int RotateMaxSpeed
        {
            get; set;
        }

        public bool IgnoreShadowFlip
        {
            get; set;
        }

        public bool ResourceFromAngle
        {
            get; set;
        }
