namespace ClashRoyale.Files.Csv.Logic
{
    public class TveGamemodeData : CsvData
    {
        ...
        public string PrimarySpells
        {
            get; set;
        }

        public string SecondarySpells
        {
            get; set;
        }

        public string CastSpells
        {
            get; set;
        }
        ...
        public int TimeToFirstWave
        {
            get; set;
        }

        public string ForcedCards1
        {
            get; set;
        }

        public string ForcedCards2
        {
            get; set;
        }

        public bool RotateDecks
        {
            get; set;
        }
