namespace ClashRoyale.Files.Csv.Logic
{
    public class LocationData : CsvData
    {
        ...
        public string WalkEffect
        {
            get; set;
        }

        public string WalkEffectOvertime
        {
            get; set;
        }
        ...
        public string LoopingEffectFinalMinute
        {
            get; set;
        }
        ...
        public string LoopingEffectOvertimeSide
        {
            get; set;
        }

        public int ReflectionRed
        {
            get; set;
        }

        public int ReflectionGreen
        {
            get; set;
        }

        public int ReflectionBlue
        {
            get; set;
        }
