namespace ClashRoyale.Files.Csv.Logic
{
    public class CharacterData : CsvData
    {
        ...
        public CharacterData(CsvRow CsvRow, CsvTable CsvTable) : base(CsvRow, CsvTable)
        {
            // CharacterData.
        }
        ...
        public bool VariableDamageLifeTime
        {
            get; set;
        }

        public int VariableDamageTransitionTime
        {
            get; set;
        }
        ...
        public string BuffWhenNotAttacking
        {
            get; set;
        }
        ...
        public string BuffWhenNotAttackingEffect
        {
            get; set;
        }

        public string BuffWhenNotAttackingRemoveEffect
        {
            get; set;
        }

        public string AreaEffectOnHit
        {
            get; set;
        }
