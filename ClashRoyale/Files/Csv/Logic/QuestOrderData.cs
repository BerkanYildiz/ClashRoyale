namespace ClashRoyale.Files.Csv.Logic
{
    public class QuestOrderData : CsvData
    {
        ...
        public int RewardAmountSmall
        {
            get; set;
        }

        public int RewardAmountLarge
        {
            get; set;
        }

        public int QuestPointsSmall
        {
            get; set;
        }

        public int QuestPointsLarge
        {
            get; set;
        }

        public int RewardAmountDaily
        {
            get; set;
        }
