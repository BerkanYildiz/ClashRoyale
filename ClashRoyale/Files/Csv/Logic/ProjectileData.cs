namespace ClashRoyale.Files.Csv.Logic
{
    public class ProjectileData : CsvData
    {
        ...
        public int CrownTowerHealPercent
        {
            get; set;
        }
        ...
        public int ChainedHitRadius
        {
            get; set;
        }

        public string ChainedHitEndEffect
        {
            get; set;
        }

        public string PingpongDeathEffect
        {
            get; set;
        }

        public bool ShakesTargets
        {
            get; set;
        }

        public int PingpongVisualTime
        {
            get; set;
        }
