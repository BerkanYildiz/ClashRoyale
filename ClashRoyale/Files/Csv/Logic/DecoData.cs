namespace ClashRoyale.Files.Csv.Logic
{
    public class DecoData : CsvData
    {
        ...
        public string AssetMinTrophy
        {
            get; set;
        }

        public int AssetMinTrophyScore
        {
            get; set;
        }

        public string AssetMinTrophyFileName
        {
            get; set;
        }
        ...
        public string CheerFileName
        {
            get; set;
        }

        public string CheerExportName
        {
            get; set;
        }
