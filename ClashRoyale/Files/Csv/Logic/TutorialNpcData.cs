...
{
    public class TutorialNpcData : CsvData
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TutorialNpcData" /> class.
        /// </summary>
        /// <param name="CsvRow">The row.</param>
        /// <param name="CsvTable">The data table.</param>
        public TutorialNpcData(CsvRow CsvRow, CsvTable CsvTable) : base(CsvRow, CsvTable)
        {
            // TutorialNpcData.
        }
