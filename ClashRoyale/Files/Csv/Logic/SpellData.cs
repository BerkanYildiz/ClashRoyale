namespace ClashRoyale.Files.Csv.Logic
{
    ...
    public class SpellData : CsvData
    {
        ...
        public bool SpellAsDeploy
        {
            get; set;
        }

        public bool CanPlaceOnBuildings
        {
            get; set;
        }
        ...
        public bool TouchdownLimitedDeploy
        {
            get; set;
        }
        ...
        public bool HideRadiusIndicator
        {
            get; set;
        }
        ...
        public bool DarkMirror
        {
            get; set;
        }

        public bool StatsUnderInfo
        {
            get; set;
        }
