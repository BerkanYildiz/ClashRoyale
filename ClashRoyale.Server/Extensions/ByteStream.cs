namespace ClashRoyale.Server.Extensions
{
    ...
    internal class ByteStream : ChecksumEncoder, IDisposable
    {
        ...
        /// </summary>
        internal override bool IsCheckSumOnlyMode
        {
            get
            {
                return false;
        ...
        /// Initializes a new instance of the <see cref="ByteStream"/> class.
        /// </summary>
        internal ByteStream(int Size) : base(null)
        {
        ...
        /// Initializes a new instance of the <see cref="ByteStream"/> class.
        /// </summary>
        internal ByteStream(byte[] Buffer) : base(null)
        {
            this.Buffer = Buffer;
        }
        ...
        /// Adds a string.
        /// </summary>
        internal override void WriteString(string String)
        {
            if (String != null)
            {
        ...
        /// </summary>
        internal override void WriteStringReference(string String)
        {
            if (String == null)
            {
        ...
        /// Adds a vint.
        /// </summary>
        internal override void WriteVInt(int Value)
        {
        ...
        /// Adds element to buffer.
        /// </summary>
        internal override void AddRange(byte[] Buffer)
        {
        ...
        /// Adds element to buffer.
        /// </summary>
        internal void AddRange(byte[] Buffer, int Length)
        {
            this.EnsureCapacity(Buffer.Length);
        ...
        /// </summary>
        internal byte[] ReadBytesReference()
        {
            int Length = this.ReadInt();
        ...
        /// Reads a byte array.
        /// </summary>
        internal byte[] ReadBytesWithoutLength(int Length)
        {
            if (this.Length < 0)
            {
        ...
        /// </summary>
        internal string ReadStringReference()
        {
            int Length = this.ReadInt();
        ...
        /// </summary>
        internal void SetByteArray(byte[] NBuffer)
        {
            this.Buffer = null;
            this.Buffer = NBuffer;
        ...
        /// Sets the byte array of this instance.
        /// </summary>
        internal void SetByteArray(byte[] NBuffer, bool ResetOffset)
        {
            this.Buffer = null;
            this.Buffer = NBuffer;
        ...
        /// Converted this instance to byte array.
        /// </summary>
        internal byte[] ToArray(int StartOffset)
        {
        ...
        /// Converted this instance to byte array.
        /// </summary>
        internal byte[] ToArray(int StartOffset, int Length)
        {
