namespace ClashRoyale.Server.Crypto.Nacl
{
    public class Salsa20
    {
        ...
        internal readonly int CryptoCoreSalsa20RefConstbytes = 16;
        internal readonly int CryptoCoreSalsa20RefInputbytes = 16;
        internal readonly int CryptoCoreSalsa20RefKeybytes = 32;
        internal readonly int CryptoCoreSalsa20RefOutputbytes = 64;
        internal readonly int CryptoStreamSalsa20RefKeybytes = 32;
        internal readonly int CryptoStreamSalsa20RefNoncebytes = 8;
        ...
        internal static int LoadLittleendian(byte[] X, int Offset)
        {
        ...
        internal static void StoreLittleendian(byte[] X, int Offset, int U)
        {
            X[Offset] = (byte) U;
            U = (int) ((uint) U >> 8);
            X[Offset + 1] = (byte) U;
