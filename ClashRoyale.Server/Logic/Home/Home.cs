namespace ClashRoyale.Server.Logic.Home
{
    ...
    internal class Home
    {
        ...
        internal void Encode(ByteStream Stream)
        {
            ...
            Stream.AddRange("1A-0D  1E-00-00     B8-2E  00-00  01           00-02  9A-05  B4-07  05-01".HexaToBytes());
            Stream.AddRange("1A-31  32-00-00     B8-2E  00-00  01           00-03  9A-05  A0-0C  05-01".HexaToBytes());
            Stream.AddRange("1B-0A  08-01-00     B8-2E  00-01  01           00-04  9A-05  B0-12  05-01".HexaToBytes());
            Stream.AddRange("1C-03  0C-01-00     B8-2E  00-00  01           00-05  9A-05  80-19  05-01".HexaToBytes());
            Stream.AddRange("1A-03  10-01-00     B8-2E  00-00  03           13     B9-04  98-01  00".HexaToBytes());
