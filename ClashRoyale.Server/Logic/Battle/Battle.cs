namespace ClashRoyale.Server.Logic.Battle
{
    ...
    {
        internal readonly GameMode GameMode;

        internal bool InOvertime;
        internal bool EndedCalled;
        internal bool EndedWithTimeOut;

        internal bool TournamentMode;
        internal bool ChallengeMatch;
        internal bool TeamVsTeamMatch;

        internal int Type;
        internal int DeckCount;
        internal int PlayerCount;
        internal int EndScreenLoadTime;
        ...
        /// </summary>
        internal int MatchLengthSeconds
        {
            get
            {
        ...
        /// </summary>
        internal int OvertimeLengthSeconds
        {
            get
            {
                if (this.TournamentMode && this.Type != 1)
        ...
        /// </summary>
        internal bool IsBattleEndedCalled
        {
            get
            {
        ...
        /// </summary>
        internal bool IsBattleEndedWithTimeOut
        {
            get
            {
        ...
        /// </summary>
        internal bool EndConditionMatched
        {
            get
            {
        ...
        internal Battle(GameMode GameMode)
        {
        ...
        /// </summary>
        internal bool CheckSpellPosition(int X, int Y, SpellData SpellData)
        {
            return true;
        }
        ...
        /// </summary>
        internal Player GetPlayerByAccountId(int HighId, int LowId)
        {
        ...
        /// </summary>
        internal Player[] GetEnemyPlayers()
        {
        ...
        /// </summary>
        internal void InitDefaultSector(TilemapData TileMapData)
        {
        ...
        /// Sets the location.
        /// </summary>
        internal void SetLocation(LocationData Data)
        {
        ...
        /// Sets the arena.
        /// </summary>
        internal void SetArena(ArenaData Data)
        {
            this.ArenaData = Data;
        }
        ...
        /// Sets the game mode.
        /// </summary>
        internal void SetGameMode(GameModeData GameMode)
        {
        ...
        /// </summary>
        internal void Encode(ChecksumEncoder Stream, Player Player)
        {
