namespace ClashRoyale.Server.Logic.Collections
{
    ...
    internal static class Clans
    {
        ...
        internal static void Add(Clan Entity)
        {
        ...
        /// </summary>
        /// <param name="Entity">The entity.</param>
        internal static async Task Remove(Clan Entity)
        {
        ...
        internal static async Task<Clan> Create(Clan Entity = null, bool Store = true)
        {
            if (Entity == null)
            {
                Entity    = new Clan();
        ...
        /// <param name="Store">Whether it has to be stored.</param>
        internal static async Task<Clan> Get(int HighId, int LowId, bool Store = true)
        {
        ...
        /// </summary>
        /// <returns></returns>
        internal static List<Clan> GetAll()
        {
        ...
        /// </summary>
        /// <param name="Entity">The entity.</param>
        internal static async Task Save(Clan Entity)
        {
