namespace ClashRoyale.Server.Logic.Collections
{
    ...
    internal static class Battles
    {
        ...
        internal static void Add(BattleLog Entity)
        {
        ...
        /// </summary>
        /// <param name="Entity">The entity.</param>
        internal static async Task Remove(BattleLog Entity)
        {
        ...
        internal static async Task<BattleLog> Create(BattleLog Entity = null, bool Store = true)
        {
            if (Entity == null)
            {
        ...
        /// <param name="Store">Whether it has to be stored.</param>
        internal static async Task<BattleLog> Get(int HighId, int LowId, bool Store = true)
        {
        ...
        /// </summary>
        /// <param name="Entity">The entity.</param>
        internal static async Task Save(BattleLog Entity)
        {
