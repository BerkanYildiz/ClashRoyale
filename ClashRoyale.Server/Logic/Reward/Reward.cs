namespace ClashRoyale.Server.Logic.Reward
{
    ...
    internal class Reward
    {
        ...
        internal List<Spell> DiscardedSpells;
        ...
        /// </summary>
        internal static Reward CreateFromType(int Type)
        {
            switch (Type)
            {
                case 0:
        ...
        /// Decodes the reward.
        /// </summary>
        internal static Reward DecodeReward(ByteStream Stream)
        {
        ...
        /// Encodes the reward.
        /// </summary>
        internal static void EncodeReward(ChecksumEncoder Stream, Reward Reward)
        {
