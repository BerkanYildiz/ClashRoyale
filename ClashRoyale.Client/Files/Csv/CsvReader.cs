namespace ClashRoyale.Client.Files.Csv
{
    ...
    internal class CsvReader
    {
        ...
        internal int GetArraySizeAt(CsvRow Row, int ColumnIndex)
        {
        ...
        /// </summary>
        /// <param name="Name">The name.</param>
        internal int GetColumnIndexByName(string Name)
        {
        ...
        /// </summary>
        /// <param name="Offset">The offset.</param>
        internal string GetColumnName(int Offset)
        {
