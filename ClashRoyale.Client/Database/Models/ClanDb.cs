namespace ClashRoyale.Client.Database.Models
{
    ...
    internal class ClanDb
    {
        ...
        internal ClanDb(int HighId, int LowId, string Json)
        {
            this.HighId     = HighId;
            this.LowId      = LowId;
        ...
        /// </summary>
        /// <param name="Clan">The clan.</param>
        internal static async Task Create(Clan Clan)
        {
        ...
        /// </summary>
        internal static async Task<ClanDb> Save(Clan Clan)
        {
        ...
        /// </summary>
        internal static async Task<ClanDb> Load(int HighId, int LowId)
        {
            if (LowId > 0)
            {
        ...
        /// </summary>
        internal bool Deserialize(out Clan Clan)
        {
