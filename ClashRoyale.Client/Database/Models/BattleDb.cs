namespace ClashRoyale.Client.Database.Models
{
    ...
    internal class BattleDb
    {
        ...
        internal BattleDb(int HighId, int LowId, string Json)
        {
            this.HighId     = HighId;
            this.LowId      = LowId;
        ...
        internal BattleDb(BattleLog BattleLog)
        {
        ...
        /// </summary>
        /// <param name="BattleLog">The battle log.</param>
        internal static async Task Create(BattleLog BattleLog)
        {
        ...
        /// </summary>
        internal static async Task<BattleDb> Save(BattleLog BattleLog)
        {
        ...
        /// </summary>
        internal static async Task<BattleDb> Load(int HighId, int LowId)
        {
            if (LowId > 0)
            {
        ...
        /// </summary>
        internal bool Deserialize(out BattleLog BattleLog)
        {
